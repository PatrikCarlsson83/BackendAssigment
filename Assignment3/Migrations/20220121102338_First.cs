        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Concerts_Cities_CityID",
                        column: x => x.CityID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserGoingConcerts", x => x.ID);
                    table.ForeignKey(
                        name: "FK_UserGoingConcerts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserGoingConcerts_Concerts_ConcertID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserGoingConcerts_ConcertID",
                table: "UserGoingConcerts",
                column: "ConcertID");

            migrationBuilder.CreateIndex(
                name: "IX_UserGoingConcerts_UserId",
                table: "UserGoingConcerts",
                column: "UserId");
        }
